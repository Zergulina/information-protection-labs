...
const RetroInput = ({value, setValue, onEnterKey, className} : RetroInputProps) => {
    ...
    return (
        <div className={classes.RetroInputContainer}>
            <input value={value} ref={inputRef} onChange = {e => handleInputChange(e.target.value)} className={`${classes.RetroInput} ${className}`} onKeyDown={(e) => e.key == 'Enter' && onEnterKey && onEnterKey()}/>
